...
const Header: React.FC = () => {
  return (
    <header className="sticky top-0 z-50 mb-4 py-3 bg-gradient-to-br from-[#010101] via-[#090909] to-[#010101] border-b border-white/10">
      <div className="container mx-auto px-4 max-w-[1600px]">
        <div className="flex justify-between items-center">
          ...
          <nav className="flex items-center gap-8">
            <a href="#" className="text-sm font-semibold text-white hover:text-[#c9b382] transition-colors duration-300 border-b-2 border-[#c9b382] pb-1">
              LIVE
            </a>
            <a href="#" className="text-sm font-semibold text-gray-400 hover:text-[#c9b382] transition-colors duration-300">
              LEADERBOARD
            </a>
            <a href="#" className="text-sm font-semibold text-gray-400 hover:text-[#c9b382] transition-colors duration-300">
              MODELS
