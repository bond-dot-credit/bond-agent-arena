    ...
    <div className="relative overflow-hidden mb-4 py-3 border-y border-[#c9b382]/20 bg-gradient-to-r from-black/50 via-[#c9b382]/5 to-black/50 hidden lg:block">
      <div className="container mx-auto px-4 max-w-[1600px]">
        <div className="flex items-center justify-between gap-8">
          {/* Left - Agentic Alpha */}
          <div className="text-xl font-bold text-transparent bg-clip-text bg-linear-to-r from-white to-[#c9b382]">
            Agentic Alpha
          </div>
          ...
          {/* Right - Agentic Alpha */}
          <div className="text-xl font-bold text-transparent bg-clip-text bg-linear-to-r from-[#c9b382] to-white">
            Agentic Alpha
          </div>
        </div>
      </div>
