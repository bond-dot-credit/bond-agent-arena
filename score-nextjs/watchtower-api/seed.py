"""Seed the database with Season 0 agent data."""
...
AGENTS = [
    {
        "name": "Giza", "ticker": "ARMA", "color": "#bced62",
        ...
        "score_trend": "stable", "days_since_scored": 1,
    },
    {
        "name": "Mamo", "ticker": "MAMO", "color": "#00d180",
        ...
        "score_trend": "up", "days_since_scored": 1,
    },
    {
        "name": "Sail", "ticker": "SAIL", "color": "#4a90b8",
        ...
        "score_trend": "stable", "days_since_scored": 2,
    },
    {
        "name": "ZyFi", "ticker": "ZYFI", "color": "#a855f7",
    ...
    {
        "name": "SurfLiquid", "ticker": "SURF", "color": "#f97316",
        ...
        "score_trend": "down", "days_since_scored": 1,
    },
]
...
def seed():
    ...
    try:
        ...
        for data in AGENTS:
            db.add(Agent(**data, last_updated=now))
        db.commit()
